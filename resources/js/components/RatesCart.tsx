            ...
            {cart.length > 0 && (
                <section aria-labelledby="cart-summary">
                    <div className="overflow-hidden rounded-2xl border border-[#9c7833]/20 bg-gradient-to-br from-white to-gray-50 shadow-lg">
                        <div className="flex bg-gradient-to-r from-[#902729] to-[#9c7833] px-6 py-4">
                        ...
                        <div className="space-y-4 p-6">
                                    ...
                                    item.kind === 'leisure-room' ? (
                                        <div className="pr-12">
                                            ...
                                            <div className="mb-3 flex items-center gap-2 text-sm">
                                                <span className="rounded-full bg-[#9c7833]/10 px-3 py-1 font-medium text-[#902729]">
                                                    {item.boardType === 'FB'
                                                        ? 'Full Board'
                                                        : item.boardType ===
                                                            'HB'
                            ...
                            <div className="rounded-xl bg-gradient-to-r from-[#902729] to-[#9c7833] p-6 text-white">
                                <div className="flex items-center justify-between">
                                    <div>
                            ...
                            <div className="flex flex-col gap-3 pt-2 sm:flex-row">
                                ...
                                <div className="flex gap-3 sm:flex-2">
                                    <button
                                        className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#902729] to-[#9c7833] px-6 py-3 font-semibold text-white transition-shadow hover:shadow-lg"
