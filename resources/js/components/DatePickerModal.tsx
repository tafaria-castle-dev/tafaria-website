                ...
                {days.map((day, i) => {
                    ...
                    return (
                        <button
                            ...
                            className={`rounded-lg p-2 text-center transition-colors ${isSelected ? 'bg-[#902729] text-white' : 'text-black'} ${inRange && !isSelected ? 'bg-[#902729]/90 text-white' : ''} ${isToday ? 'font-bold text-[#902729]' : ''} ${dayWithoutTime < today ? 'cursor-not-allowed text-gray-400' : 'hover:bg-gray-100'} `}
                        >
                            {format(day, 'd')}
                        </button>
                    );
    ...
    return (
        <>
            ...
            <div
                ...
                className="absolute z-60 w-auto overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl"
            >
                <div className="mb-4 flex items-center justify-between">
                    ...
                    <button
                        className="rounded-lg bg-[#902729] px-5 py-1 text-white hover:bg-[#9c7833]"
                        onClick={onClose}
                    >
                        Done
                    </button>
