...
const styles = `
  ...
  .micro { font-size: 0.78rem; color: #8a6830; font-weight: 500; }
  ...
  .card-media { height: 180px; overflow: hidden; background: linear-gradient(135deg, rgba(90,62,43,0.15), rgba(184,146,75,0.15)); }
  ...
  .grid-4 { display: grid; gap: 18px; grid-template-columns: repeat(4,1fr); margin-top: 16px; }
